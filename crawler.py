...
with open ( "/Users/jaewanpark/Documents/jaewan/developing/projects/frontend/naver_movie_crawling/samples.csv", "w", newline ="",encoding = 'utf8' ) as f:
    write = csv.writer(f)
